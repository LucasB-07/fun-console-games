...
class PasswordChecker
{
    static void Main()
    {
        ...
        while (checkAgain)
        {
            ...
            //6. Common Patterns
            if (Regex.IsMatch(password, @"(123456|password|qwerty|!@#$%^&*()_|letmein|welcome|admin|iloveyou|token|secret|wasd|abc123|111111|123123|password123|lol|lol123)", RegexOptions.IgnoreCase))
            {
                score -= 20;
